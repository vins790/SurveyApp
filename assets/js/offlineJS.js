...
setInterval(function refreshURL(){
    Offline.options = {checks: {image: {url: 'https://www.kirupa.com/blank.png?' + new Date().getTime()}, active: 'image'}, interceptRequests: true, reconnect: { initialDelay: 6, delay: (6)}, requests: true, deDupBody: true};
}, 1000);
